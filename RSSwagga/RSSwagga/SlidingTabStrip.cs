...
namespace RSSwagga
{
    public class SlidingTabStrip : LinearLayout
    {
        ...
        private int[] INDICATOR_COLORS = { 0xFFFF00, 0xff9d1e };
        ...
        {
            mSelectedPosition = position; //Current position of user on tab
            mSelectionOffset = positionOffset; //New position of user on tab
            this.Invalidate(); //Redraws everything
        }
        ...
        {
            int height = Height;
            int tabCount = ChildCount; //How many tabs
            ...
            //Colored line under current selection
            if (tabCount > 0)
            {
        ...
        //Returns proper colors from an array
        private class SimpleTabColorizer : SlidingTabScrollView.TabColorizer
        {
            private int[] mIndicatorColors;
            private int[] mDividerColors;

            //Gets different colors from mIndicatorColors array
            public int GetIndicatorColor(int position)
            {
                return mIndicatorColors[position % mIndicatorColors.Length];
            }

            //Gets different colors from mDividerColors array
